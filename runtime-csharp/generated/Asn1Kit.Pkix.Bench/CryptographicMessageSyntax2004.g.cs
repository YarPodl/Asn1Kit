...
public sealed class EncryptedContentInfo
{
    ...
    public Asn1Kit.Pkix.Bench.AlgorithmIdentifier ContentEncryptionAlgorithm { get; set; }
...
{
    public Asn1Kit.Pkix.Bench.AlgorithmIdentifier Algorithm { get; set; }
...
public sealed class PasswordRecipientInfo
{
    ...
    public Asn1Kit.Pkix.Bench.AlgorithmIdentifier? KeyDerivationAlgorithm { get; set; }
    /// <summary>ASN.1 alias KeyEncryptionAlgorithmIdentifier ::= AlgorithmIdentifier.</summary>
    public Asn1Kit.Pkix.Bench.AlgorithmIdentifier KeyEncryptionAlgorithm { get; set; }
    /// <summary>ASN.1 alias EncryptedKey ::= OCTET STRING.</summary>
    public ReadOnlyMemory<byte> EncryptedKey { get; set; }
...
public sealed class RevocationInfoChoice
{
    ...
    public Asn1Kit.Pkix.Bench.CertificateList? Crl { get; private set; }
    public OtherRevocationInfoFormat? Other { get; private set; }

    public static RevocationInfoChoice FromCrl(Asn1Kit.Pkix.Bench.CertificateList crl) => new RevocationInfoChoice
    {
    ...
    public static RevocationInfoChoice Decode(Asn1Reader reader)
    {
        ...
        if (peeked.MatchesIgnoreConstructed(Asn1Tag.Sequence))
        {
            ...
            value.Crl = Asn1Kit.Pkix.Bench.CertificateList.Decode(reader, Asn1Tag.Sequence);
        }
        else if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true)))
        {
...
public sealed class CertificateChoices
{
    ...
    public Asn1Lazy<Asn1Kit.Pkix.Bench.Certificate>? Certificate { get; private set; }
    public ExtendedCertificate? ExtendedCertificate { get; private set; }
    public OtherCertificateFormat? Other { get; private set; }

    public static CertificateChoices FromCertificate(Asn1Lazy<Asn1Kit.Pkix.Bench.Certificate> certificate) => new CertificateChoices
    {
    ...
    public void Encode(Asn1Writer writer)
    {
        switch (Kind)
        {
            case CertificateChoicesKind.Certificate:
                if (Certificate.HasEncoded)
                {
                    writer.WriteRaw(Certificate.EncodedMemory.Span);
                }
                else
                {
                    Certificate.Value.Encode(writer, Asn1Tag.Sequence);
                }
                break;
    ...
    public static CertificateChoices Decode(Asn1Reader reader)
    {
        ...
        if (peeked.MatchesIgnoreConstructed(Asn1Tag.Sequence))
        {
            ...
            value.Certificate = reader.ReadLazy(static r => Asn1Kit.Pkix.Bench.Certificate.Decode(r, Asn1Tag.Sequence));
        }
        else if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 0, true)))
        {
...
public sealed class ExtendedCertificateOrCertificate
{
    ...
    public Asn1Kit.Pkix.Bench.Certificate? Certificate { get; private set; }
    public ExtendedCertificate? ExtendedCertificate { get; private set; }

    public static ExtendedCertificateOrCertificate FromCertificate(Asn1Kit.Pkix.Bench.Certificate certificate) => new ExtendedCertificateOrCertificate
    {
