...
public sealed class AuthorityKeyIdentifier
{
    ...
    public static AuthorityKeyIdentifier Decode(Asn1Reader reader, Asn1Tag tag)
    {
        using (reader.EnterSequence(tag))
        {
            ...
            {
                value.AuthorityCertIssuer = reader.ReadSequenceOf(new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true), static inner => Asn1Kit.Pkix.GeneralName.Decode(inner));
            }
...
public sealed class PolicyInformation
{
    ...
    public static PolicyInformation Decode(Asn1Reader reader, Asn1Tag tag)
    {
        using (reader.EnterSequence(tag))
        {
            ...
            {
                value.PolicyQualifiers = reader.ReadSequenceOf(Asn1Tag.Sequence, static inner => Asn1Kit.Pkix.PolicyQualifierInfo.Decode(inner, Asn1Tag.Sequence));
            }
            return value;
        }
    }
...
public sealed class UserNotice
{
    ...
    public static UserNotice Decode(Asn1Reader reader, Asn1Tag tag)
    {
        using (reader.EnterSequence(tag))
        {
            ...
            {
                value.NoticeRef = Asn1Kit.Pkix.NoticeReference.Decode(reader, Asn1Tag.Sequence);
            }
            ...
            {
                value.ExplicitText = Asn1Kit.Pkix.DisplayText.Decode(reader);
            }
            return value;
        }
    }
...
public sealed class NoticeReference
{
    ...
    public static NoticeReference Decode(Asn1Reader reader, Asn1Tag tag)
    {
        using (reader.EnterSequence(tag))
        {
            ...
            value.Organization = Asn1Kit.Pkix.DisplayText.Decode(reader);
...
public sealed class GeneralName
{
    ...
    public static GeneralName Decode(Asn1Reader reader)
    {
        ...
        if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 0, true)))
        {
            ...
            value.OtherName = Asn1Kit.Pkix.AnotherName.Decode(reader, new Asn1Tag(Asn1TagClass.ContextSpecific, 0, true));
        }
        ...
        else if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 3, true)))
        {
            ...
            value.X400Address = Asn1Kit.Pkix.ORAddress.Decode(reader, new Asn1Tag(Asn1TagClass.ContextSpecific, 3, true));
        }
        else if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 4, true)))
        {
            ...
            value.DirectoryName = reader.ReadSequenceOf(new Asn1Tag(Asn1TagClass.ContextSpecific, 4, true), static inner => inner.ReadSetOf(Asn1Tag.Set, static inner => Asn1Kit.Pkix.AttributeTypeAndValue.Decode(inner, Asn1Tag.Sequence)));
        }
        else if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 5, true)))
        {
            ...
            value.EdiPartyName = Asn1Kit.Pkix.EDIPartyName.Decode(reader, new Asn1Tag(Asn1TagClass.ContextSpecific, 5, true));
        }
...
public sealed class EDIPartyName
{
    ...
    public static EDIPartyName Decode(Asn1Reader reader, Asn1Tag tag)
    {
        using (reader.EnterSequence(tag))
        {
            ...
            {
                value.NameAssigner = Asn1Kit.Pkix.DirectoryString.Decode(reader);
            }
            value.PartyName = Asn1Kit.Pkix.DirectoryString.Decode(reader);
            return value;
        }
    }
...
public sealed class NameConstraints
{
    ...
    public static NameConstraints Decode(Asn1Reader reader, Asn1Tag tag)
    {
        using (reader.EnterSequence(tag))
        {
            ...
            {
                value.PermittedSubtrees = reader.ReadSequenceOf(new Asn1Tag(Asn1TagClass.ContextSpecific, 0, true), static inner => Asn1Kit.Pkix.GeneralSubtree.Decode(inner, Asn1Tag.Sequence));
            }
            ...
            {
                value.ExcludedSubtrees = reader.ReadSequenceOf(new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true), static inner => Asn1Kit.Pkix.GeneralSubtree.Decode(inner, Asn1Tag.Sequence));
            }
            return value;
        }
    }
...
public sealed class GeneralSubtree
{
    ...
    public static GeneralSubtree Decode(Asn1Reader reader, Asn1Tag tag)
    {
        using (reader.EnterSequence(tag))
        {
            ...
            value.Base = Asn1Kit.Pkix.GeneralName.Decode(reader);
...
public sealed class DistributionPoint
{
    ...
    public static DistributionPoint Decode(Asn1Reader reader, Asn1Tag tag)
    {
        using (reader.EnterSequence(tag))
        {
            ...
            {
                value.DistributionPointValue = Asn1Kit.Pkix.DistributionPointName.Decode(reader);
            }
            ...
            {
                value.Reasons = Asn1Kit.Pkix.ReasonFlags.Decode(reader, new Asn1Tag(Asn1TagClass.ContextSpecific, 1, false));
            }
            ...
            {
                value.CRLIssuer = reader.ReadSequenceOf(new Asn1Tag(Asn1TagClass.ContextSpecific, 2, true), static inner => Asn1Kit.Pkix.GeneralName.Decode(inner));
            }
            return value;
        }
    }
...
public sealed class DistributionPointName
{
    ...
    public static DistributionPointName Decode(Asn1Reader reader)
    {
        ...
        if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 0, true)))
        {
            ...
            value.FullName = reader.ReadSequenceOf(new Asn1Tag(Asn1TagClass.ContextSpecific, 0, true), static inner => Asn1Kit.Pkix.GeneralName.Decode(inner));
        }
        else if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true)))
        {
            ...
            value.NameRelativeToCRLIssuer = reader.ReadSetOf(new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true), static inner => Asn1Kit.Pkix.AttributeTypeAndValue.Decode(inner, Asn1Tag.Sequence));
        }
        else throw new Asn1Exception("Unknown CHOICE alternative.");
        return value;
    }
...
public sealed class AccessDescription
{
    ...
    public static AccessDescription Decode(Asn1Reader reader, Asn1Tag tag)
    {
        using (reader.EnterSequence(tag))
        {
            ...
            value.AccessLocation = Asn1Kit.Pkix.GeneralName.Decode(reader);
            return value;
        }
    }
...
public sealed class IssuingDistributionPoint
{
    ...
    public static IssuingDistributionPoint Decode(Asn1Reader reader, Asn1Tag tag)
    {
        using (reader.EnterSequence(tag))
        {
            ...
            if (reader.TryPeekTag(out var tag_DistributionPoint) && tag_DistributionPoint.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 0, true)))
            {
                value.DistributionPoint = Asn1Kit.Pkix.DistributionPointName.Decode(reader);
            }
            ...
            {
                value.OnlySomeReasons = Asn1Kit.Pkix.ReasonFlags.Decode(reader, new Asn1Tag(Asn1TagClass.ContextSpecific, 3, false));
            }
