...
public sealed class SignedData
{
    ...
    public Asn1Kit.Pkix.AlgorithmIdentifier[] DigestAlgorithms { get; set; } = Array.Empty<Asn1Kit.Pkix.AlgorithmIdentifier>();
    ...
    public static SignedData Decode(Asn1Reader reader, Asn1Tag tag)
    {
        return reader.ReadSequence(tag, inner =>
        {
            ...
            value.EncapContentInfo = Asn1Kit.Cms.EncapsulatedContentInfo.Decode(inner, Asn1Tag.Sequence);
            ...
            {
                value.Certificates = inner.ReadSetOf(new Asn1Tag(Asn1TagClass.ContextSpecific, 0, true), static inner => Asn1Kit.Cms.CertificateChoices.Decode(inner));
            }
            if (inner.TryPeekTag(out var tag_Crls) && tag_Crls.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true)))
            {
                value.Crls = inner.ReadSetOf(new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true), static inner => Asn1Kit.Cms.RevocationInfoChoice.Decode(inner));
            }
            value.SignerInfos = inner.ReadSetOf(Asn1Tag.Set, static inner => Asn1Kit.Cms.SignerInfo.Decode(inner, Asn1Tag.Sequence));
            return value;
        });
    }
...
public sealed class SignerInfo
{
    ...
    public static SignerInfo Decode(Asn1Reader reader, Asn1Tag tag)
    {
        return reader.ReadSequence(tag, inner =>
        {
            ...
            value.Version = inner.ReadInt32(Asn1Tag.Integer);
            value.Sid = Asn1Kit.Cms.SignerIdentifier.Decode(inner);
            ...
            {
                value.SignedAttrs = inner.ReadSetOf(new Asn1Tag(Asn1TagClass.ContextSpecific, 0, true), static inner => Asn1Kit.Cms.Attribute.Decode(inner, Asn1Tag.Sequence));
            }
            ...
            {
                value.UnsignedAttrs = inner.ReadSetOf(new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true), static inner => Asn1Kit.Cms.Attribute.Decode(inner, Asn1Tag.Sequence));
            }
            return value;
        });
    }
...
public sealed class SignerIdentifier
{
    ...
    public static SignerIdentifier Decode(Asn1Reader reader)
    {
        ...
        if (peeked.MatchesIgnoreConstructed(Asn1Tag.Sequence))
        {
            ...
            value.IssuerAndSerialNumber = Asn1Kit.Cms.IssuerAndSerialNumber.Decode(reader, Asn1Tag.Sequence);
        }
...
public sealed class EnvelopedData
{
    ...
    public static EnvelopedData Decode(Asn1Reader reader, Asn1Tag tag)
    {
        return reader.ReadSequence(tag, inner =>
        {
            ...
            {
                value.OriginatorInfo = Asn1Kit.Cms.OriginatorInfo.Decode(inner, new Asn1Tag(Asn1TagClass.ContextSpecific, 0, true));
            }
            value.RecipientInfos = inner.ReadSetOf(Asn1Tag.Set, static inner => Asn1Kit.Cms.RecipientInfo.Decode(inner));
            value.EncryptedContentInfo = Asn1Kit.Cms.EncryptedContentInfo.Decode(inner, Asn1Tag.Sequence);
            ...
            {
                value.UnprotectedAttrs = inner.ReadSetOf(new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true), static inner => Asn1Kit.Cms.Attribute.Decode(inner, Asn1Tag.Sequence));
            }
            return value;
        });
    }
...
public sealed class OriginatorInfo
{
    ...
    public static OriginatorInfo Decode(Asn1Reader reader, Asn1Tag tag)
    {
        return reader.ReadSequence(tag, inner =>
        {
            ...
            {
                value.Certs = inner.ReadSetOf(new Asn1Tag(Asn1TagClass.ContextSpecific, 0, true), static inner => Asn1Kit.Cms.CertificateChoices.Decode(inner));
            }
            if (inner.TryPeekTag(out var tag_Crls) && tag_Crls.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true)))
            {
                value.Crls = inner.ReadSetOf(new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true), static inner => Asn1Kit.Cms.RevocationInfoChoice.Decode(inner));
...
public sealed class RecipientInfo
{
    ...
    public static RecipientInfo Decode(Asn1Reader reader)
    {
        ...
        if (peeked.MatchesIgnoreConstructed(Asn1Tag.Sequence))
        {
            ...
            value.Ktri = Asn1Kit.Cms.KeyTransRecipientInfo.Decode(reader, Asn1Tag.Sequence);
        }
        else if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true)))
        {
            value.Kind = RecipientInfoKind.Kari;
            value.Kari = Asn1Kit.Cms.KeyAgreeRecipientInfo.Decode(reader, new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true));
        }
        else if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 2, true)))
        {
            ...
            value.Kekri = Asn1Kit.Cms.KEKRecipientInfo.Decode(reader, new Asn1Tag(Asn1TagClass.ContextSpecific, 2, true));
        }
        else if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 3, true)))
        {
            value.Kind = RecipientInfoKind.Pwri;
            value.Pwri = Asn1Kit.Cms.PasswordRecipientInfo.Decode(reader, new Asn1Tag(Asn1TagClass.ContextSpecific, 3, true));
        }
        else if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 4, true)))
        {
            value.Kind = RecipientInfoKind.Ori;
            value.Ori = Asn1Kit.Cms.OtherRecipientInfo.Decode(reader, new Asn1Tag(Asn1TagClass.ContextSpecific, 4, true));
        }
        else throw new Asn1Exception("Unknown CHOICE alternative.");
        return value;
    }
...
public sealed class KeyTransRecipientInfo
{
    ...
    public static KeyTransRecipientInfo Decode(Asn1Reader reader, Asn1Tag tag)
    {
        return reader.ReadSequence(tag, inner =>
        {
            ...
            value.Version = inner.ReadInt32(Asn1Tag.Integer);
            value.Rid = Asn1Kit.Cms.RecipientIdentifier.Decode(inner);
...
public sealed class KeyAgreeRecipientInfo
{
    ...
    public static KeyAgreeRecipientInfo Decode(Asn1Reader reader, Asn1Tag tag)
    {
        return reader.ReadSequence(tag, inner =>
        {
            ...
            value.Version = inner.ReadInt32(Asn1Tag.Integer);
            value.Originator = inner.ReadSequence(new Asn1Tag(Asn1TagClass.ContextSpecific, 0, true), nested => Asn1Kit.Cms.OriginatorIdentifierOrKey.Decode(nested));
            ...
            value.KeyEncryptionAlgorithm = Asn1Kit.Pkix.AlgorithmIdentifier.Decode(inner, Asn1Tag.Sequence);
            value.RecipientEncryptedKeys = inner.ReadSequenceOf(Asn1Tag.Sequence, static inner => Asn1Kit.Cms.RecipientEncryptedKey.Decode(inner, Asn1Tag.Sequence));
            return value;
        });
    }
...
public sealed class OriginatorIdentifierOrKey
{
    ...
    public static OriginatorIdentifierOrKey Decode(Asn1Reader reader)
    {
        ...
        else if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true)))
        {
            ...
            value.OriginatorKey = Asn1Kit.Cms.OriginatorPublicKey.Decode(reader, new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true));
        }
        else throw new Asn1Exception("Unknown CHOICE alternative.");
        return value;
    }
...
public sealed class RecipientEncryptedKey
{
    ...
    public static RecipientEncryptedKey Decode(Asn1Reader reader, Asn1Tag tag)
    {
        return reader.ReadSequence(tag, inner =>
        {
            ...
            value.Rid = Asn1Kit.Cms.KeyAgreeRecipientIdentifier.Decode(inner);
            value.EncryptedKey = inner.ReadOctetString(Asn1Tag.OctetString);
            return value;
        });
    }
...
public sealed class KeyAgreeRecipientIdentifier
{
    ...
    public static KeyAgreeRecipientIdentifier Decode(Asn1Reader reader)
    {
        ...
        else if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 0, true)))
        {
            ...
            value.RKeyId = Asn1Kit.Cms.RecipientKeyIdentifier.Decode(reader, new Asn1Tag(Asn1TagClass.ContextSpecific, 0, true));
        }
        else throw new Asn1Exception("Unknown CHOICE alternative.");
        return value;
    }
...
public sealed class RecipientKeyIdentifier
{
    ...
    public static RecipientKeyIdentifier Decode(Asn1Reader reader, Asn1Tag tag)
    {
        return reader.ReadSequence(tag, inner =>
        {
            ...
            {
                value.Other = Asn1Kit.Cms.OtherKeyAttribute.Decode(inner, Asn1Tag.Sequence);
            }
            return value;
        });
    }
...
public sealed class KEKRecipientInfo
{
    ...
    public static KEKRecipientInfo Decode(Asn1Reader reader, Asn1Tag tag)
    {
        return reader.ReadSequence(tag, inner =>
        {
            ...
            value.Version = inner.ReadInt32(Asn1Tag.Integer);
            value.Kekid = Asn1Kit.Cms.KEKIdentifier.Decode(inner, Asn1Tag.Sequence);
            value.KeyEncryptionAlgorithm = Asn1Kit.Pkix.AlgorithmIdentifier.Decode(inner, Asn1Tag.Sequence);
            value.EncryptedKey = inner.ReadOctetString(Asn1Tag.OctetString);
            return value;
        });
...
{
    public Asn1Oid OriType { get; set; }
...
public sealed class AuthenticatedData
{
    ...
    public static AuthenticatedData Decode(Asn1Reader reader, Asn1Tag tag)
    {
        return reader.ReadSequence(tag, inner =>
        {
            ...
            {
                value.AuthAttrs = inner.ReadSetOf(new Asn1Tag(Asn1TagClass.ContextSpecific, 2, true), static inner => Asn1Kit.Cms.Attribute.Decode(inner, Asn1Tag.Sequence));
            }
            ...
            {
                value.UnauthAttrs = inner.ReadSetOf(new Asn1Tag(Asn1TagClass.ContextSpecific, 3, true), static inner => Asn1Kit.Cms.Attribute.Decode(inner, Asn1Tag.Sequence));
            }
            return value;
        });
    }
...
public sealed class RevocationInfoChoice
{
    ...
    public static RevocationInfoChoice Decode(Asn1Reader reader)
    {
        ...
        else if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true)))
        {
            ...
            value.Other = Asn1Kit.Cms.OtherRevocationInfoFormat.Decode(reader, new Asn1Tag(Asn1TagClass.ContextSpecific, 1, true));
        }
        else throw new Asn1Exception("Unknown CHOICE alternative.");
        return value;
    }
...
{
    public Asn1Oid OtherRevInfoFormat { get; set; }
...
public sealed class CertificateChoices
{
    ...
    public static CertificateChoices Decode(Asn1Reader reader)
    {
        ...
        else if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 0, true)))
        {
            ...
            value.ExtendedCertificate = Asn1Kit.Cms.ExtendedCertificate.Decode(reader, new Asn1Tag(Asn1TagClass.ContextSpecific, 0, true));
        }
        else if (peeked.MatchesIgnoreConstructed(new Asn1Tag(Asn1TagClass.ContextSpecific, 3, true)))
        {
            value.Kind = CertificateChoicesKind.Other;
            value.Other = Asn1Kit.Cms.OtherCertificateFormat.Decode(reader, new Asn1Tag(Asn1TagClass.ContextSpecific, 3, true));
        }
        else throw new Asn1Exception("Unknown CHOICE alternative.");
        return value;
    }
...
{
    public Asn1Oid OtherCertFormat { get; set; }
...
public sealed class IssuerAndSerialNumber
{
    ...
    public Asn1Kit.Pkix.AttributeTypeAndValue[][] Issuer { get; set; } = Array.Empty<Asn1Kit.Pkix.AttributeTypeAndValue[]>();
...
{
    public Asn1Oid KeyAttrId { get; set; }
...
public sealed class ExtendedCertificate
{
    ...
    public static ExtendedCertificate Decode(Asn1Reader reader, Asn1Tag tag)
    {
        return reader.ReadSequence(tag, inner =>
        {
            ...
            value.ExtendedCertificateInfo = Asn1Kit.Cms.ExtendedCertificateInfo.Decode(inner, Asn1Tag.Sequence);
            value.SignatureAlgorithm = Asn1Kit.Pkix.AlgorithmIdentifier.Decode(inner, Asn1Tag.Sequence);
...
public sealed class ExtendedCertificateInfo
{
    ...
    public static ExtendedCertificateInfo Decode(Asn1Reader reader, Asn1Tag tag)
    {
        return reader.ReadSequence(tag, inner =>
        {
            ...
            value.Attributes = inner.ReadSetOf(Asn1Tag.Set, static inner => Asn1Kit.Cms.Attribute.Decode(inner, Asn1Tag.Sequence));
            return value;
        });
    }
